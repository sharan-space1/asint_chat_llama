		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Chat Llama",
									"targetURL": "#comasintragchatllamaapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comasintragchatllamaapp-display": {
								"semanticObject": "comasintragchatllamaapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.asint.rag.chatllama.app",
									"url": sap.ui.require.toUrl("com/asint/rag/chatllama/app")
								}
							}
						}
					}
